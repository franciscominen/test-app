export const DataProducts = [
    {id: 'X0DtSu3ziM', name: 'Palta', categoryId: 'verduras', 
    ...
    {id: 'cvIK77kDt0', name: 'Cerdo', categoryId: 'carnes', 
    ...
    {id: 'yfHczA-0-T', name: 'Jabon', categoryId: 'cosmetica', 
    ...
    {id: '5P-kQVDkON', name: 'Whisky', categoryId: 'bebidas', 
    ...
    {id: 'tKeZR2mn2Z', name: 'Mostachones', categoryId: 'pastas', 
    ...
    {id: '3HDRoys-Ma', name: 'Queso', categoryId: 'lacteos', 
